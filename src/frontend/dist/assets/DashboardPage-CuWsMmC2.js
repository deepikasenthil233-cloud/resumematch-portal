import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, L as Link, U as Upload, S as Spinner } from "./index-BsJz-7pb.js";
import { B as Badge } from "./badge-CExX_7kH.js";
import { S as Skeleton } from "./skeleton-Hn6cyVdj.js";
import { a as useGetCandidateProfile, c as useGetMyMatches, d as useListAllJobs, e as useGetMyResume } from "./useBackend-BGjhrPXf.js";
import { C as ChartColumn, a as Clock } from "./clock-Dk-94O4k.js";
import { F as FileText, R as RefreshCw } from "./refresh-cw-SY9HDTYS.js";
import { C as ChevronUp, a as ChevronDown } from "./chevron-up-CYGWcmZ4.js";
/**
...
function ScoreBadge({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "leading-none", children: [
        score,
        "%"
      ] })
    }
...
function accentBarColor(score) {
  if (score >= 80) return "bg-[oklch(0.65_0.15_146)]";
  if (score >= 60) return "bg-[oklch(0.72_0.18_70)]";
  return "bg-destructive";
}
function accentTextColor(score) {
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-card p-5 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium uppercase tracking-wide text-muted-foreground mb-1.5", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: `font-display text-2xl font-bold leading-none ${accent ? "text-[oklch(0.55_0.14_146)]" : "text-foreground"}`,
          children: value
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `rounded-lg p-2 ${accent ? "bg-[oklch(0.65_0.15_146)]/10" : "bg-muted"}`,
...
function BreakdownTable({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border bg-muted/30 px-5 py-4 space-y-4", children: [
        ((job == null ? void 0 : job.description) || ((job == null ? void 0 : job.requirements.skills) ?? []).length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2", children: [
          (job == null ? void 0 : job.description) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-1.5", children: "Job Description" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed line-clamp-3", children: job.description })
          ] }),
          ((job == null ? void 0 : job.requirements.skills) ?? []).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-1.5", children: "Required Skills" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: job.requirements.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: skill }, skill)) })
          ] })
        ] }),
        sorted.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-2", children: "Score Breakdown" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/50 border-b border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left text-xs font-semibold text-muted-foreground", children: "Requirement" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-center text-xs font-semibold text-muted-foreground w-24", children: "Score" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left text-xs font-semibold text-muted-foreground hidden sm:table-cell", children: "AI Feedback" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: sorted.map((req, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: req.requirement }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 w-14 rounded-full bg-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 hidden sm:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs leading-relaxed", children: req.feedback || "—" }) })
                  ]
                },
                req.requirement
              );
...
function ExpandableMatchCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-1 w-full ${barColor}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 pt-0.5 min-w-[56px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-xs font-semibold text-muted-foreground", children: [
                  "#",
                  rank
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreBadge, { score, size: "lg" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground truncate", children: (job == null ? void 0 : job.title) ?? "Job Posting" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      variant: "outline",
                ...
                (job == null ? void 0 : job.description) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground line-clamp-1 mb-2", children: job.description }),
                match.breakdown.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mt-2", children: [
                  [...match.breakdown].sort((a, b) => Number(b.score) - Number(a.score)).slice(0, 3).map((req) => {
                    const s = Number(req.score);
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                  ...
                  match.breakdown.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs text-muted-foreground bg-muted", children: [
                    "+",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-2 shrink-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4" }) })
              ] })
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(BreakdownTable, { breakdown: match.breakdown, job }) })
      ]
    }
  );
}
function DashboardPage() {
  ...
  const isLoading = profileLoading || matchesLoading || jobsLoading || resumeLoading;
  const sortedMatches = [...matches].sort(
    (a, b) => Number(b.overallScore) - Number(a.overallScore)
  );
  const jobMap = new Map(
    jobs.map((j) => [j.id.toString(), j])
  );
  const bestScore = sortedMatches.length > 0 ? Number(sortedMatches[0].overallScore) : null;
  const avgScore = sortedMatches.length > 0 ? Math.round(
    sortedMatches.reduce((sum, m) => sum + Number(m.overallScore), 0) / sortedMatches.length
  ) : null;
  const matchingInProgress = !isLoading && !!resume && matchesLoaded && sortedMatches.length === 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "dashboard.header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: profileLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-52" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: (profile == null ? void 0 : profile.name) ? `Welcome back, ${profile.name.split(" ")[0]} 👋` : "Your Match Dashboard" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 text-sm text-muted-foreground", children: "Your resume vs every open job — scored and ranked transparently." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/upload", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "mr-1.5 h-3.5 w-3.5" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8 space-y-8", children: [
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 sm:grid-cols-3", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 w-full rounded-xl" }, n)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              StatCard,
              {
                ...
                sub: bestScore !== null ? matchLabel(bestScore) : void 0
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              StatCard,
              {
                ...
                sub: avgScore !== null ? "across all matches" : void 0
              }
            )
          ]
        }
      ),
      !isLoading && !resume && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-8 w-8 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground", children: "No resume uploaded yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground max-w-sm", children: "Upload your resume and TalentFlow will instantly match you against all open jobs — with full score transparency." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                asChild: true,
      ...
      matchingInProgress && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-8 w-8 text-muted-foreground animate-spin" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground", children: "Matching in progress…" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground max-w-sm", children: "Our AI is analyzing your resume against all open jobs. This usually takes a few moments — check back shortly." }),
      ...
      !isLoading && sortedMatches.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "dashboard.matches_section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground hidden sm:block", children: "Click any card to see the full breakdown" })
        ] }),
        sortedMatches.every((m) => Number(m.overallScore) === 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-amber-600 shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-amber-700 dark:text-amber-400", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Match scores may be pending" }),
                " ",
                "— the AI analysis usually completes within a minute. If scores remain at 0%, ask your admin to verify the AI key is configured in the admin panel, then re-upload your resume."
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "dashboard.matches_list", children: sortedMatches.map((match, idx) => {
      ...
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "dashboard.loading_state", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-36 w-full rounded-xl" }, n)) }),
      !isLoading && !matchingInProgress && resume && sortedMatches.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Inbox, { className: "mb-3 h-10 w-10 text-muted-foreground" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-1", children: "No open jobs right now" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: "There are no open positions available at the moment. Check back soon — new jobs are posted regularly." })
          ]
        }
      )
    ] })
